          ...
          <Card className="max-w-md w-full">
            <CardContent className="text-center p-8">
              ...
              <p className="text-gray-600 mb-6">
                Gracias por contactarnos. Nos comunicaremos contigo dentro de las próximas 2 horas.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ¿Tienes alguna pregunta sobre el cuidado de tu mascota? Nuestro equipo de expertos 
              está listo para ayudarte en cualquier momento.
            </p>
          </div>
              ...
              <Card className="border-0 shadow-lg bg-red-50 border-red-200">
                ...
                <CardContent>
                  <p className="text-sm text-red-600 mb-4">
                    Para emergencias veterinarias fuera del horario regular, contáctanos inmediatamente:
                  </p>
                  <div className="space-y-2">
              ...
              <Card className="border-0 shadow-lg bg-green-50">
                ...
                <CardContent>
                  <p className="text-sm text-green-600">
                    Recuerda mantener actualizadas las vacunas de tu mascota. 
                    Un calendario de vacunación al día es la mejor prevención.
                  </p>
                </CardContent>
              </Card>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Visítanos en nuestras modernas instalaciones</p>
          </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Av. Universitaria 123, San Martín de Porres, Lima</p>
                    <p className="text-sm text-gray-500">Referencia: Frente al Centro Comercial Megaplaza</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Línea 1 del Metro - Estación Caquetá</p>
                    <p className="text-sm text-gray-500">Buses: Líneas 301, 302, 304 (Paradero Universitaria)</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Estacionamiento</h3>
                    <p className="text-gray-600">Estacionamiento gratuito disponible</p>
                    <p className="text-sm text-gray-500">Espacios para 20 vehículos + área para motos</p>
                  </div>
                </div>
              </div>
