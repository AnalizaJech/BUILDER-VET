...
export const ClientAvatar: React.FC<{ name: string; className?: string }> = ({ name, className }) => (
  <PersonAvatar name={name} className={className} size="md" />
);

export const TestimonialAvatar: React.FC<{ name: string; className?: string }> = ({ name, className }) => (
...
export const TeamAvatar: React.FC<{ memberIndex?: number; className?: string }> = ({ 
  memberIndex = 0, 
  className 
}) => {
